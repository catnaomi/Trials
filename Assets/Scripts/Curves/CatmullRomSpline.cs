...
public class CatmullRomSpline : MonoBehaviour
{
	...
	void OnDrawGizmos()
	{
		...
		Gizmos.DrawSphere(GetCatmullRomPosition(tTest, controlPointsList[0].position, controlPointsList[1].position, controlPointsList[2].position, controlPointsList[3].position), 0.05f);
	}
