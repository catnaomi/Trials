...
{
    [CustomEditor(typeof(GradientTextureBSplineNoHDR), true), CanEditMultipleObjects]
    public class GradientTextureHDREditor : UnityEditor.Editor
    {
        GradientTextureBSplineNoHDR _gradientTexture;
        ...
        void OnEnable()
        {
            _gradientTexture = target as GradientTextureBSplineNoHDR;
        }
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (GUILayout.Button(buttonText))
            {
                ...
                {
                    GradientTextureBSplineNoHDR targetTexture = target as GradientTextureBSplineNoHDR;
        ...
        public override void DrawPreview(Rect previewArea)
        {
            ...
            if (check && texture && (_editor == null || _editor.target != texture))
            {
                try
                {
                    _editor = CreateEditor(targets.Select(t => (t as GradientTextureBSplineNoHDR)?.GetTexture()).ToArray());
                }
                catch
                {
                    _editor = null;
