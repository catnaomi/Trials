...
{
    public class ProjectIconsUtilityHDR : MonoBehaviour
    {
        [DidReloadScripts]
        static ProjectIconsUtilityHDR()
        {
        ...
        static void ItemOnGUI(string guid, Rect rect)
        {
            ...
            var asset = AssetDatabase.LoadAssetAtPath<GradientTextureBSplineNoHDR>(assetPath);
